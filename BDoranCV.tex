...
\begin{addmargin}{.5in}
  ...
  \end{itemize}
  %%% CERTIFICATE %%%
  \experiencetitle{Harvard University, Extension School}{Cambridge MA}{Jan 2018}{Professional Graduate-level Certificate in Data Science }(GPA: 4.0) \\ \\
  %%% RELEVANT COURSES %%%
...
\begin{addmargin}{.5in}
  ...
  %%% E-23a - HARVARD EXT. %%%
  \experiencetitle{E-23a - Harvard Extension School}{Cambridge MA}{Jan 2018-May 2018}{Teaching Fellow, Game Development}
    \begin{itemize}\setlength\itemsep{-4pt}
